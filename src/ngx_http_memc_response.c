...
parse_memc_storage(int *cs_addr, u_char *p, u_char *pe, ngx_uint_t *status_addr, ngx_flag_t *done_addr)
{
    ...
    #line 491 "src/ngx_http_memc_response.rl"
    
#line 572 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st54:
	if ( ++p == pe )
		goto _test_eof54;
case 54:
#line 740 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 492 "src/ngx_http_memc_response.rl"
...
#line 1088 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1230 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 1380 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st39:
	if ( ++p == pe )
		goto _test_eof39;
case 39:
#line 1515 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
st40:
	if ( ++p == pe )
		goto _test_eof40;
case 40:
#line 1677 "src/ngx_http_memc_response.c"
	if ( (*p) == 13 )
		goto st36;
	goto st35;
st37:
...
#line 1755 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st43:
	if ( ++p == pe )
		goto _test_eof43;
case 43:
#line 1896 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
st44:
	if ( ++p == pe )
		goto _test_eof44;
case 44:
#line 2098 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 13: goto st35;
		case 69: goto st37;
	}
...
#line 2182 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st45:
	if ( ++p == pe )
		goto _test_eof45;
case 45:
#line 2338 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 2608 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 2637 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 13: goto tr6;
		case 32: goto tr7;
	}
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 2655 "src/ngx_http_memc_response.c"
	if ( (*p) == 10 )
		goto tr8;
	goto st0;
tr8:
...
st40:
	if ( ++p == pe )
		goto _test_eof40;
case 40:
#line 2715 "src/ngx_http_memc_response.c"
	goto st0;
tr7:
#line 26 "src/ngx_http_memc_response.rl"
	{
...
st4:
	if ( ++p == pe )
		goto _test_eof4;
case 4:
#line 2727 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 13: goto tr6;
		case 32: goto tr7;
	}
...
st5:
	if ( ++p == pe )
		goto _test_eof5;
case 5:
#line 2743 "src/ngx_http_memc_response.c"
	if ( (*p) == 76 )
		goto tr9;
	goto st0;
tr9:
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 2757 "src/ngx_http_memc_response.c"
	if ( (*p) == 73 )
		goto tr10;
	goto st0;
tr10:
...
st7:
	if ( ++p == pe )
		goto _test_eof7;
case 7:
#line 2771 "src/ngx_http_memc_response.c"
	if ( (*p) == 69 )
		goto tr11;
	goto st0;
tr11:
...
st9:
	if ( ++p == pe )
		goto _test_eof9;
case 9:
#line 2799 "src/ngx_http_memc_response.c"
	if ( (*p) == 84 )
		goto tr13;
	goto st0;
tr13:
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 2813 "src/ngx_http_memc_response.c"
	if ( (*p) == 95 )
		goto tr14;
	goto st0;
tr14:
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 2827 "src/ngx_http_memc_response.c"
	if ( (*p) == 69 )
		goto tr15;
	goto st0;
tr15:
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 2841 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr16;
	goto st0;
tr16:
...
st13:
	if ( ++p == pe )
		goto _test_eof13;
case 13:
#line 2855 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr17;
	goto st0;
tr17:
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 2869 "src/ngx_http_memc_response.c"
	if ( (*p) == 79 )
		goto tr18;
	goto st0;
tr18:
...
st15:
	if ( ++p == pe )
		goto _test_eof15;
case 15:
#line 2883 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr19;
	goto st0;
tr19:
...
st16:
	if ( ++p == pe )
		goto _test_eof16;
case 16:
#line 2897 "src/ngx_http_memc_response.c"
	if ( (*p) == 32 )
		goto tr20;
	goto st0;
tr20:
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 2911 "src/ngx_http_memc_response.c"
	if ( (*p) == 13 )
		goto tr21;
	goto tr20;
tr21:
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 2925 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 10: goto tr22;
		case 13: goto tr21;
	}
...
st19:
	if ( ++p == pe )
		goto _test_eof19;
case 19:
#line 2941 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr23;
	goto st0;
tr23:
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 2955 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr24;
	goto st0;
tr24:
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 2969 "src/ngx_http_memc_response.c"
	if ( (*p) == 79 )
		goto tr25;
	goto st0;
tr25:
...
st25:
	if ( ++p == pe )
		goto _test_eof25;
case 25:
#line 3025 "src/ngx_http_memc_response.c"
	if ( (*p) == 79 )
		goto tr28;
	goto st0;
tr28:
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 3053 "src/ngx_http_memc_response.c"
	if ( (*p) == 95 )
		goto tr30;
	goto st0;
tr30:
...
st28:
	if ( ++p == pe )
		goto _test_eof28;
case 28:
#line 3067 "src/ngx_http_memc_response.c"
	if ( (*p) == 70 )
		goto tr31;
	goto st0;
tr31:
...
st29:
	if ( ++p == pe )
		goto _test_eof29;
case 29:
#line 3081 "src/ngx_http_memc_response.c"
	if ( (*p) == 79 )
		goto tr32;
	goto st0;
tr32:
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 3095 "src/ngx_http_memc_response.c"
	if ( (*p) == 85 )
		goto tr33;
	goto st0;
tr33:
...
st31:
	if ( ++p == pe )
		goto _test_eof31;
case 31:
#line 3109 "src/ngx_http_memc_response.c"
	if ( (*p) == 78 )
		goto tr34;
	goto st0;
tr34:
...
st32:
	if ( ++p == pe )
		goto _test_eof32;
case 32:
#line 3123 "src/ngx_http_memc_response.c"
	if ( (*p) == 68 )
		goto tr35;
	goto st0;
tr35:
...
st33:
	if ( ++p == pe )
		goto _test_eof33;
case 33:
#line 3137 "src/ngx_http_memc_response.c"
	if ( (*p) == 13 )
		goto tr36;
	goto st0;
tr36:
...
st34:
	if ( ++p == pe )
		goto _test_eof34;
case 34:
#line 3151 "src/ngx_http_memc_response.c"
	if ( (*p) == 10 )
		goto tr37;
	goto st0;
tr5:
...
st38:
	if ( ++p == pe )
		goto _test_eof38;
case 38:
#line 3207 "src/ngx_http_memc_response.c"
	if ( (*p) == 69 )
		goto tr41;
	goto st0;
tr41:
