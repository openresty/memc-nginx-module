...
#line 599 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st54:
	if ( ++p == pe )
		goto _test_eof54;
case 54:
#line 767 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 1118 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1260 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 1413 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st39:
	if ( ++p == pe )
		goto _test_eof39;
case 39:
#line 1548 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
st40:
	if ( ++p == pe )
		goto _test_eof40;
case 40:
#line 1710 "src/ngx_http_memc_response.c"
	if ( (*p) == 13 )
		goto st36;
	goto st35;
st37:
...
#line 1791 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st43:
	if ( ++p == pe )
		goto _test_eof43;
case 43:
#line 1932 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
st44:
	if ( ++p == pe )
		goto _test_eof44;
case 44:
#line 2134 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 13: goto st35;
		case 69: goto st37;
	}
...
#line 2221 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st45:
	if ( ++p == pe )
		goto _test_eof45;
case 45:
#line 2377 "src/ngx_http_memc_response.c"
	goto st0;
st16:
	if ( ++p == pe )
		goto _test_eof16;
...
#line 2650 "src/ngx_http_memc_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 2679 "src/ngx_http_memc_response.c"
	switch( (*p) ) {
		case 13: goto tr6;
		case 32: goto tr7;
	}
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 2697 "src/ngx_http_memc_response.c"
	if ( (*p) == 10 )
		goto tr8;
	goto st0;
tr8:
...
st37:
	if ( ++p == pe )
		goto _test_eof37;
case 37:
#line 3235 "src/ngx_http_memc_response.c"
	if ( (*p) == 86 )
		goto tr40;
	goto st0;
tr40:
...
st38:
	if ( ++p == pe )
		goto _test_eof38;
case 38:
#line 3249 "src/ngx_http_memc_response.c"
	if ( (*p) == 69 )
		goto tr41;
	goto st0;
tr41:
...
st39:
	if ( ++p == pe )
		goto _test_eof39;
case 39:
#line 3263 "src/ngx_http_memc_response.c"
	if ( (*p) == 82 )
		goto tr13;
	goto st0;
	}
